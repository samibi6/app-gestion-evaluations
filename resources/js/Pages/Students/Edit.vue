                    ...
                    <form @submit.prevent="submit" class="max-w-7xl mx-auto p-6 lg:p-8">
                        ...
                        <div class="flex justify-center gap-2">
                            <button :disabled="form.processing"
                                class="text-white bg-blue-900 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
                                Sauvegarder
                            </button>
                            <button type="button"
