...
<template>
    <AppLayout title="CoursSection">
        ...
        <div class="py-12">
            <div class="py-5 mx-auto bg-white rounded-lg max-w-7xl sm:px-6 lg:px-8">
                <button class="bg-blue-500 text-white font-bold p-3 rounded-full hover:bg-blue-800 m-2"
                    @click="add = !add">
