        ...
        <table style="width: 100%;">
                        ...
                        <tr>
                            ...
                            <td colspan="4" class="t-2" style="border: 0;">
                                <table style="width: 100%;">
                                    ...
                                    ?>
                                    <tr>
                                        <td style="width: 57.2%; padding: .5em;">{{ $criteria->description }}</td>
                                    ...
                                    <tr>
                                        <td style="width: 57%; font-weight: bold; text-align: center; padding: .5em;">
            ...
            <tr style="line-height: 1.5em;">
                ...
                <td style="width: 33%; text-align: center; padding: .5em;"><span style="font-weight: bold;">Au moins un
                        ...
                        1<span style="vertical-align: super; font-size: .7em;">ère</span> session) </span><br><span style="font-weight: bold;"> AJOURNEMENT </span><br> &#10132; Voir justification ajournement</td>
                <td style="width: 33%; text-align: center; padding: .5em;"><span style="font-weight: bold;">Au moins un
                        AA non-acquis</span><span style="font-size: .5em;"> (en
                        2<span style="vertical-align: super; font-size: .7em;">ème</span> session) </span><br><span style="font-weight: bold;"> REFUS </span><br> &#10132; Voir justification de refus</td>
            </tr>
            <tr>
                <td colspan="3" style="font-weight: bold; text-align: center; font-size: 15px; border-top: 4px solid #718096; padding: .5em;">
