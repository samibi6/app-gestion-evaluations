    ...
    <main>
                ...
                <td class="t-1" colspan="3">
                    <table style="width: 100%;">
                        <tr style="font-weight: bold;">
                            <td colspan="3" style="padding: 1em; font-size: 10px; color: gray;">
                                (Indiquer
                                ici le
                                chapeau repris
                                au-dessus des acquis d'apprentissage dans le dossier pédagogique)</td>
                                ...
                                <td colspan="4" class="t-2" style="border: 0;">
                                    <table style="width: 100%;">
                                        ...
                                        @foreach ($criteriaByApt[$aptitude->id] as $criteria)
                                            ...
                                            ?>
                                            <tr>
                                                <td style="width: 57.2%; padding: .5em;">{{ $criteria->description }}
                                                </td>
        ...
        <table style="width: 100%;">
            ...
            @foreach ($proficiencies as $proficiency)
                <?php
                $n++;
                $cote += $acquiredProf[$proficiency->id];
                ?>
                <tr>
                    ...
                    <td style="text-align: center; padding: .5em;">
                        {{ $i === $finalD ? $acquiredProf[$proficiency->id] : '-' }} /10</td>
                </tr>
            @endforeach
            <?php
            if ($critot === $critPass) {
