...
<body>
    <main>
        ...
        <table style="width: 100%;" class="empty-space-2">
            <div>L'étudiant.e est <span style="text-decoration: underline; font-weight : bold;">refusé.e</span> pour
        ...
        <table style="width:100%;" class="blunders">
            <tr>
                <td>
                    <div style="font-size: 1.4em;margin-left:2em;">-     fraude, plagiat ou non-citation des sources
                        dans une épreuve certificative de <div style="margin-left: 1.6em;">2<sup>ème </sup>session</div>
                    </div>
                    <div
                    ...
                    <div class="data" style="margin-left: 1em; font-size:1.4em;">
                        {{ $courseStudentData->denied_blunder_1_justification ? "$courseStudentData->denied_blunder_1_justification" : '' }}
                    </div>
                </td>
                <td style="width:8%;"><input type="checkbox"
                        {{ $courseStudentData->denied_blunder_1 ? 'checked' : '' }}
                        style="margin-top: -2em;margin-left:1em;"></td>
            </tr>
            <tr>
                <td>
                    <div style="font-size: 1.4em;margin-left:2em;">-     récidive de fraude, plagiat ou
                        non-citation des sources dans une épreuve <div style="margin-left: 1.6em;"> certificative de
                            1<sup>ère </sup>session</div>
                    </div>
                    <div
                        style="font-size:1.4em;font-style:italic;text-decoration:underline;margin-left:0.5em;margin-top:1em;margin-bottom:1em;">
                        Justification et explication :</div>
                    <div class="data" style="margin-left: 1em; font-size:1.4em;">
                        {{ $courseStudentData->denied_blunder_2_justification ? "$courseStudentData->denied_blunder_2_justification" : '' }}
                    </div>
                </td>
                <td style="width:8%;"><input type="checkbox"
                        {{ $courseStudentData->denied_blunder_2 ? 'checked' : '' }}
                        style="margin-top: -2em;margin-left:1em;"></td>
            </tr>
            <tr style="border-bottom:none;">
                ...
                <td style="width:8%;"><input type="checkbox"
                        {{ $courseStudentData->denied_blunder_3 ? 'checked' : '' }}
                        style="margin-top: 0;margin-left:1em;"></td>
            </tr>
            ...
            <tr style="border-bottom:none;">
                ...
                <td style="width:8%;"><input type="checkbox"
                        {{ $courseStudentData->denied_blunder_4 ? 'checked' : '' }}
                        style="margin-top: 0;margin-left:1em;"></td>
            </tr>
            <tr style="border-bottom:none;">
                <td style="border-bottom:none;">
                ...
                <td style="width:8%;"><input type="checkbox"
                        {{ $courseStudentData->denied_blunder_5 ? 'checked' : '' }}
                        style="margin-top: 0;margin-left:1em;"></td>
            </tr>
        </table>
            ...
            <tr>
                <td style="position:relative;">
                    <div
                        ...
                        Justification et explication :</div>
                    <div class="data" style="margin-left: 1em; font-size:1.4em;">
                        {{ $courseStudentData->denied_justification_global ? "$courseStudentData->denied_justification_global" : '' }}
                    </div>
                    <div style="bottom:0;margin-left: 1em;margin-top:1em;font-style:italic;font-size:1.1em;">(+ Joindre
                        la grille d'évaluation)</div>
                </td>
        ...
        <div style="margin-top:3em;font-size:1.4em;">Voies de recours interne<sup>2</sup> :
            <div style="margin-top:1em;font-style:italic">
                <p>Tout élève a le droit d'introduire un recours écrit contre les décisions de refus prises à son égard
                    par le conseil des études. Ce recours doit impérativement mentionner les irrégularités précises qui
                    le motivent.</p>
                <p>L'introduction d'un recours interne ne peut se faire que sur base d'une plainte écrite adressée par
                    pli recommandé au chef d'établissement ou réceptionné(e) par celui-ci contre accusé de réception.
                    Cette plainte doit être déposée au plus tard le 4<sup>ème</sup> jour calendrier qui suit la
                    publication des résultats.</p>
                <p>L'adresse où la plainte doit être expédiées ou déposée est la suivante :</p>
            </div>
        </div>
        ...
        <div style="margin-top: 1em;font-weight:bold;font-size:1.4em;"> <span style="margin-left:1em;">Le conseil des
                études (nom+titre),</span><span style="margin-left:6.5em;">La direction,</span></div>
        ...
        <div style="position:absolute;bottom:-1em;">
            ...
            <div style="margin-top: 1em;font-size:1.2em;text-justify:inter-word;"><sup>2</sup> Uniquement en cas de
                <span style="font-weight:bold;">refus</span> dans une unité d'enseignement ou à <span
                    style="font-weight:bold;">l'épreuve intégrée</span>. (cfr. Base légale)
            </div>
