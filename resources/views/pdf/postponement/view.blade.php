...
<body>
    ...
    <table class="student"><tr>
       ...
       <table  style="width: 100%;" class="empty-space-2">
           <div>L'étudiant.e est <span style="text-decoration: underline; font-weight : bold;">ajourné.e</span> pour le(s) motif(s) suivant(s)<sup>1</sup> :</div>
           </table> 

        <table style="width:100%;" class="blunders">
            <tr>
                <td><div style="font-size: 1.4em;margin-left:2em;">-     fraude, plagiat ou non-citation des sources dans une épreuve certificative</div><div style="font-size:1.4em;font-style:italic;text-decoration:underline;margin-left:0.5em;margin-top:1em;margin-bottom:1em;">Justification et explication :</div> <div class="data" style="margin-left: 1em; font-size:1.4em;"> {{ $courseStudentData->adjournment_blunder_1_justification ? "$courseStudentData->adjournment_blunder_1_justification" : '' }}</div></td>
                <td style="width:8%;"><input type="checkbox" {{ $courseStudentData->adjournment_blunder_1 ? "checked" : '' }} style="margin-top: -2em;margin-left:1em;"></td>
            </tr>
            <tr>
            <td>
...
<td style="width:8%;"><input type="checkbox" {{ $courseStudentData->adjournment_blunder_2 ? "checked" : '' }} style=";margin-left:1em;"></td>
            </tr>
        </table>
